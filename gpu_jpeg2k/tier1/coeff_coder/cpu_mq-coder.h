...
*/
#ifndef CPU_MQ_CODER_H_
#define CPU_MQ_CODER_H_

#include "cpu_c2luts.h"
...
struct MQDecoder : public MQEncoder
{
 ...
 unsigned char getI(MQEncoder &enc, int id)
{
	unsigned char out = 0;
 ...
 void setI(MQEncoder &enc, int id, unsigned char value)
{
 ...
 short GetNthBit(int &reg, int n)
{
 ...
 void coderResetInd(unsigned char indices[])
{
	#pragma unroll
	for(int i = 1; i < 19; i++)
		indices[i] = 0;
 ...
 void mqResetEnc(MQEncoder &encoder)
{
	encoder.Ib0 = 0;
	encoder.Ib1 = 0;
	encoder.Ib2 = 0;
 ...
 void mqResetDec(MQDecoder &decoder)
{
 ...
 void mqInitEnc(MQEncoder &encoder, byte *outbuf)
{
	encoder.A = 0x8000;
	encoder.C = 0;
	encoder.CT = 12;
...
//#define BYTEOUT_OPTIMIZED
 ...
 void putByte(MQEncoder &encoder)
{
	if(encoder.L >= 0)
 ...
 void nonStuffedOut(MQEncoder &encoder)
{
	putByte(encoder);
 ...
 void stuffedOut(MQEncoder &encoder)
{
	putByte(encoder);
 ...
 void byteout(MQEncoder &encoder)
{
#ifndef BYTEOUT_OPTIMIZED
// alternative version
 ...
 void renorme(MQEncoder &encoder)
{
	do
	{
 ...
 void codemps(MQEncoder &encoder)
{
 ...
 void codelps(MQEncoder &encoder)
{
	unsigned int p = Qe[getI(encoder, encoder.CX)];
 ...
 void setbits(MQEncoder &encoder)
{
...
typedef long long int __int64;
 ...
 int calcFmin(MQEncoder &encoder)
{
 ...
 int mqFullFlush(MQEncoder &encoder)
{
 ...
 void mqEncode(MQEncoder &encoder, int decision, int context)
{
	#ifdef DEBUG_MQ
	/* debug purposes */
	Cstates[l++] = encoder.C;
 ...
 int mps_exchange(MQDecoder &decoder)
{
 ...
 void FillLSBs(MQDecoder &decoder)
{
	decoder.CT = 8;
 ...
 void mqInitDec(MQDecoder &decoder, byte *inbuf, int codeLength)
{
/*
	decoder.T = 0;
...
*/
 ...
 int getActive(MQDecoder &decoder)
{
	return (decoder.C >> 16) & (unsigned int) 0xFFFF;
}

 void setActive(MQDecoder &decoder, int value)
{
